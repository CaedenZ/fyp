...
transform = torchvision.transforms.Compose([torchvision.transforms.Resize((350,851)),torchvision.transforms.ToTensor()])# TODO: compose transforms here
dataset = torchvision.datasets.ImageFolder(data_fold) # TODO: create the ImageFolder
...
train_loader = DataLoader(dataset, shuffle=True, batch_size=128, num_workers=4)
